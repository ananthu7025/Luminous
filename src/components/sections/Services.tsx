...
const servicesData: ServiceCard[] = [
  {
    ...
    icon: 'ns-shape-25',
    iconType: 'shape',
    title: 'AI & Intelligent Systems Engineering',
    description: 'Integrating LLMs, computer vision, and predictive analytics into your products. We build autonomous agents and intelligent automation that redefine efficiency.',
  },
  {
    id: 2,
    icon: 'ns-shape-17',
    ...
    description: 'Custom web and mobile applications built on modern stacks — Next.js, React, React Native, Node.js. Optimized for performance and scalability.',
  },
  {
    id: 3,
    icon: 'ns-shape-19',
    ...
    description: 'Purpose-built software engineered for your exact workflows. We architect solutions from the ground up for your specific business logic.',
  },
  {
    id: 4,
    icon: 'ns-shape-34',
    ...
    description: 'Mapping business goals to detailed technical roadmaps. No surprises, no scope creep — just clear, actionable strategy for engineering success.',
  },
  {
    id: 5,
    icon: 'local-seo',
    ...
    description: 'From MVP validation to full-scale enterprise products. We architect, build, and iterate SaaS platforms built to scale and dominate the market.',
  },
  {
    id: 6,
    icon: 'analytics',
    iconType: 'svg',
    title: 'UI/UX Design',
    description: 'User-centred interfaces that convert. Every screen is designed with your end user\'s journey in mind — clean, intuitive, and high-performance.',
  },
];

const Services = ({ hideButton = false }: { hideButton?: boolean }) => {
  return (
            ...
            <div className="lg:sticky lg:top-28">
              ...
              <div className="space-y-2 md:max-w-[595px] mb-14">
                <RevealAnimation delay={0.2}>
                  <h2>Our Expertise, Your Competitive Advantage</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="max-w-[512px]">
                    Full-stack digital product delivery — from architecture to deployment — across web, mobile, and cloud.
                  </p>
                </RevealAnimation>
              </div>
              {!hideButton && (
