...
const clientLogos: ClientLogo[] = [
  { id: '1', src: ScapicLogo, alt: 'Scapic company logo', width: 135, height: 45 },
  { id: '2', src: AsanaLogo, alt: 'Asana company logo', width: 128, height: 45 },
  { id: '3', src: DiscordLogo, alt: 'Discord company logo', width: 160, height: 45 },
  { id: '4', src: DropboxLogo, alt: 'Dropbox company logo', width: 164, height: 45 },
  { id: '5', src: HotjarLogo, alt: 'Hotjar company logo', width: 124, height: 45 },
  { id: '6', src: LatticeLogo, alt: 'Lattice company logo', width: 148, height: 45 },
  { id: '7', src: NotionLogo, alt: 'Notion company logo', width: 128, height: 45 },
  { id: '8', src: OutreachLogo, alt: 'Outreach company logo', width: 168, height: 45 },
  { id: '9', src: SpotifyLogo, alt: 'Spotify company logo', width: 136, height: 45 },
  { id: '10', src: SquarespaceLogo, alt: 'Squarespace company logo', width: 250, height: 45 },
  { id: '11', src: StripeLogo, alt: 'Stripe company logo', width: 123, height: 45 },
];
      ...
      <div className="main-container">
        <RevealAnimation delay={0.1}>
          <h2
            ...
            Trusted by innovative businesses around the globe.
          </h2>
        </RevealAnimation>
      </div>
      ...
      <RevealAnimation delay={0.2}>
        <div>
          <Marquee
            ...
            aria-label="Logos of companies we have worked with">
...
Clients.displayName = 'LuminousClients';
