...
const featureItems: FeatureItem[] = [
  {
    ...
    description: 'Every technical decision is tied to a business goal. We challenge requirements that don\'t serve your users or your growth.',
    side: 'left',
  },
  {
    id: 2,
    ...
    description: 'One team handles design, development, QA, and deployment. No handoff gaps, no finger-pointing.',
    side: 'left',
  },
  {
    id: 3,
    ...
    description: 'Weekly updates, shared project boards, and honest timelines. You always know where your product stands.',
    side: 'left',
  },
  {
    id: 4,
    ...
    description: 'We don\'t disappear after go-live. Bug fixes, iterations, and feature rollouts — we stay in the loop.',
    side: 'right',
  },
  {
    id: 5,
    ...
    description: 'MVPs in 6–10 weeks. Production-grade quality. We\'ve built the systems to move fast without technical debt.',
    side: 'right',
  },
];
              ...
              <div className="md:w-full space-y-7 text-center md:text-left">
                <div className="md:w-full space-y-3">
                  <RevealAnimation delay={0.2}>
                    <h2 className="max-w-[700px] text-accent">A Software Partner That Stays Accountable to Your Outcomes</h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.3}>
                    <p className="max-w-[500px] md:w-full text-accent/60">
                      We work as an extension of your team — not a vendor you manage.
                    </p>
                  </RevealAnimation>
                </div>
                <RevealAnimation delay={0.4}>
                  <div>
                    <LinkButton href="/contact-us" className="btn btn-dark btn-md hover:btn-white">
                      Start your project
                    </LinkButton>
                  </div>
                </RevealAnimation>
                ...
                <RevealAnimation delay={0.4} offset={100}>
                  <figure className="md:max-w-[350px] lg:max-w-[400px] xl:max-w-[480px] rounded-2xl md:w-full order-last md:order-none">
                    <Image
                      ...
                      alt="Luminous Logics accountability"
