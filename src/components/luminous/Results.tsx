...
const resultCards: ResultCard[] = [
  {
    ...
    value: '175+',
    description: 'Modules and features shipped across client products',
  },
  {
    id: 2,
    category: 'Client Satisfaction',
    value: '100%',
    description: 'Every client rates us 5 stars on quality and delivery',
  },
  {
    id: 3,
    category: 'Global Clients',
    value: '50+',
    description: 'Businesses across India, Kuwait, and Canada',
  },
  {
    id: 4,
    category: 'Support Response',
    value: '< 4 hours',
    description: 'Even after your product goes live',
  },
  {
    id: 5,
    category: 'Team Experience',
    value: '150+',
    description: 'Combined years of engineering and product expertise',
  },
];
        ...
        <div className="main-container">
          <div className="space-y-14 mb-[70px] text-center sm:text-left mx-4 sm:mx-0">
            <div className="space-y-3">
              <RevealAnimation delay={0.1}>
                <h2 className="text-secondary dark:text-accent">Stats at a Glance</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.2}>
                <p className="text-secondary/60 dark:text-accent/60">
                  A trusted software partner for startups, enterprises, and everything in between.
                </p>
              </RevealAnimation>
            </div>
