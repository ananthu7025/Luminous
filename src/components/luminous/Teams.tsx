...
const Teams = () => {
  const teams: ITeamMember[] = getMarkDownData('src/data/luminous/team', false, 'name').slice(0, 6);
  return (
        ...
        <div className="text-center space-y-5">
          ...
          <div className="max-w-[620px] mx-auto space-y-3">
            <RevealAnimation delay={0.2}>
              <h2>The people behind Luminous Logics</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                A passionate team of engineers, designers, and strategists — each bringing unique expertise and a shared
